...
need=["const BUILD='SOT-turn01-base-r13-hierarchical-master-detail'","function editingSurface(){","function tagSuggest(input){","async function tagKey(e,input){","async function commitTagEditor(){","function draw(){","function dashboard(){"]
for x in need:
...
# Add runtime listeners directly before the generated dashboard function.
runtime="""
