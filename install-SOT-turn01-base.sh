...
# Final build identity. Base-3 contains one installer EXPECTED_BUILD marker,
# one temp API build assertion, and two identical JSON build assertions
# (live health and volume API). Replace those duplicate assertions together.
replace_exact("EXPECTED_BUILD='2026.08.28.sot-turn01-base-3'",
              "EXPECTED_BUILD='2026.08.28.sot-turn01-base-7'", 1, 'expected build')
replace_exact("if(api.BUILD!=='2026.08.28.sot-turn01-base-3')",
              "if(api.BUILD!=='2026.08.28.sot-turn01-base-7')", 1, 'temp API build gate')
replace_exact("assert x.get('build')=='2026.08.28.sot-turn01-base-3',x",
              "assert x.get('build')=='2026.08.28.sot-turn01-base-7',x", 2, 'live/volume API build gates')
...
grep -q "assert x.get('build')=='2026.08.28.sot-turn01-base-7',x" "$TMP/base7-installer.sh"
[ "$(grep -Fc "assert x.get('build')=='2026.08.28.sot-turn01-base-7',x" "$TMP/base7-installer.sh")" -eq 2 ]
