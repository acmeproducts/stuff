...
new='.chartChromeRow{--hz-half:132px;height:44px;min-width:0;position:relative;display:flex;align-items:center;justify-content:center;gap:8px;padding:5px 9px;border-bottom:1px solid #1c3449}'
