...
asp=importlib.util.spec_from_file_location("sotreleasebai",HERE/"sot-turn02-release-b-ai.py");ai_mod=importlib.util.module_from_spec(asp);sys.modules[asp.name]=ai_mod;asp.loader.exec_module(ai_mod)
AI=None
