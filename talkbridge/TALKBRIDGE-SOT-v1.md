...
**6.5 Tap-to-speak / auto-read.** Tapping a bubble's language column speaks it (TTS). Auto-read on speaks incoming translations. TTS default off, persists per room; auto-read default off.
*Accept:* column tap speaks; auto-read speaks incoming when on.
