<!-- TALKBRIDGE-PLAN v21.31.0 -->
# TALKBRIDGE MASTER PLAN v21.31.0
...
| 27·ship | **Video call surface** | Spec §7.6 + R12, PENDING R13 (see §7.6 addendum below) | **REJECTED 2026-09-14 → buried G53 (partner video missing; tap collapsed to a single 9:16 window). Address rolled back byte-exact to accepted 27·pre-ship. RCA incomplete — two leads ruled out, cause not yet found.** BLOCKED pending a full inventory of every call/PiP-adjacent CSS and JS site before any candidate 3. | https://acmeproducts.github.io/stuff/bridge-turn27-ship.html (accepted pre-ship bytes) |
