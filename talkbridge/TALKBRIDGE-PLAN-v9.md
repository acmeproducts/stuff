<!-- TALKBRIDGE-PLAN v21.36.0 -->
# TALKBRIDGE MASTER PLAN v21.36.0
...
| 27·ship | **Video call surface, rescoped** — corner-band PiP fully removed (V2 dropped entirely, not reimplemented); tap-swap big/small (kept, proven correct); camera-flip relocated to an overlay on the big video surface; small video draggable anywhere including near/off-screen with a visible edge handle (R16). Screen share still dropped. | Spec §7.6, rescoped | **BUILT 2026-09-14, candidate 4 — device gate pending (G1, G3–G4 rescoped, G6, G8).** Gates pass; mutations 4/4 including direct re-tests of G52 and G53. | https://acmeproducts.github.io/stuff/bridge-turn27-ship.html |
