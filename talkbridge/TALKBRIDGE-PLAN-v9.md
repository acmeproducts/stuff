<!-- TALKBRIDGE-PLAN v21.28.0 -->
# TALKBRIDGE MASTER PLAN v21.28.0
...
| 27·ship | **Video call surface** — corner-band PiP removed; tap-swap big/small; back-button reduced 9:16 draggable box with red hang-up + expand; small video independently draggable in normal calls; camera flip; WhatsApp-style screen share | Spec §7.6 | **BUILT 2026-09-13 — device gate pending (G1–G8).** Gates M1–M5 PASS, mutations 3/3. App-only; relay/workers unchanged. | https://acmeproducts.github.io/stuff/bridge-turn27-ship.html |
