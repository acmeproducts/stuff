<!-- TALKBRIDGE-PLAN v21.30.0 -->
# TALKBRIDGE MASTER PLAN v21.30.0
...
| 27·ship | **Video call surface** — corner-band PiP removed; tap-swap big/small; back-button reduced 9:16 draggable box with red hang-up + expand; small video independently draggable in normal calls; camera flip (CSS-gated to an active video call, R12/G52 fix). Screen share DROPPED, unscheduled — owner to sequence when wanted. | Spec §7.6 + R12 | **BUILT 2026-09-14, candidate 2 — device gate pending (G1–G4, G6, G8; G5/G7 drop with share).** Gates pass; mutations 3/3 including a direct re-test of the G52 regression. | https://acmeproducts.github.io/stuff/bridge-turn27-ship.html |
