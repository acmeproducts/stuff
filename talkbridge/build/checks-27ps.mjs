...
const MARKERS = ['GAP PART · C1-signal-queue.js', 'GAP PART · V2-relay-retry.js', 'GAP PART · C3-joiner-restart.js', 'GAP PART · C2-stall-frames.js', 'GAP PART · S2-back-absorb.js', 'GAP PART · F1-flip-keeps-sender.js', 'GAP PART · K1-device-ids.js', 'GAP PART · K2-pb-merge.js', 'GAP PART · K4-rename-lww.js', 'GAP PART · T1-render-coalesce.js', 'GAP PART · T2-log-hygiene.js', 'GAP PART · T3-wrap-map.js'];
...
function checkStructure(html) {
  ...
  return 'tags balanced, twelve parts present in order (six carried, K-1, K-2, K-4, T-1, T-2, T-3); D1 absent';
}
...
async function checkRuntime(html) {
  ...
  dom.window.close();
  return 'boots clean; D1 gone; carried wrappers, K-1/K-2/K-4, T-1/T-2/T-3 installed; wrap_map logged; c5 swap/flip surface live';
}
const CHECKS = [
