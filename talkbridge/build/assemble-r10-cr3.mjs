#!/usr/bin/env node
/* R10-CR3 assembler (plan v20.12.0 §4.13.1). Proves the frozen inputs from the
...
const swPart = fs.readFileSync(path.join(root, 'talkbridge/parts/r10-cr3-sw.js'), 'utf8');
...
out = '<!-- R10-CR3 build · bridge-turn24-post-ship · plan v20.12.0 §4.13 · frozen R10.2 bytes ' + frozen['bridge-turn24-post-ship.html'].slice(0, 12) + ' + talkbridge/parts/r10-cr3-event-state.js · pair: relay v6.2 -->' + out.slice(firstNl);
const tail = '\n</script>\n</body>\n</html>';
