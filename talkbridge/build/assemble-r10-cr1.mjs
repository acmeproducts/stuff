#!/usr/bin/env node
/* R10-CR1 assembler (plan v20.9.0 §4.11.1). Proves the frozen inputs from the
...
const swPart = fs.readFileSync(path.join(root, 'talkbridge/parts/r10-cr1-sw.js'), 'utf8');
...
out = '<!-- R10-CR1 build · bridge-turn24-post-ship · plan v20.9.0 §4.11 · frozen R10.2 bytes ' + frozen['bridge-turn24-post-ship.html'].slice(0, 12) + ' + talkbridge/parts/r10-cr1-event-state.js · pair: relay v6.0 -->' + out.slice(firstNl);
const tail = '\n</script>\n</body>\n</html>';
