...
const ARTIFACT='market-navigator-turn27-pre-ship.html';
const results=[];
...
(async()=>{
 ...
 try{
   ...
   await page.waitForFunction(()=>window.__mnShip25&&window.__mnShip25.ready()&&window.__mnTurn26&&window.__mnTurn27,{timeout:30000});
