...
if len(sys.argv) != 3:
    raise SystemExit('usage: generate-SOT-turn01-base19.py <clean-base3-api.js> <output-api.js>')
...
src = src.replace("const BUILD = '2026.08.28.sot-turn01-base-3';", "const BUILD = '2026.08.29.sot-turn01-base-19';", 1)

for marker in [
    "const BUILD = '2026.08.29.sot-turn01-base-19';",
    ...
    '$env:SOT_PATH', '$env:SOT_NAME', '/mnt/c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe'
]:
    if marker not in src:
        raise SystemExit(f'Base-19 contract missing: {marker}')
if '$args[0]' in src or '$args[1]' in src:
    raise SystemExit('rejected PowerShell positional argument transport survived')
...
print('Base-19 generated directly from clean Base-3 with Windows-native env transport')
