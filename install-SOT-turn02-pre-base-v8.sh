#!/usr/bin/env bash
set -euo pipefail
REF="0f633de218406aa78e7f599f0f98dbf259c5efba"
ROOT="$HOME/.sot-turn02/v8"
...
curl -fsSL "$BASE/SOT/sot-turn02-v8.service" -o "$HOME/.config/systemd/user/sot-turn02-v8.service"
...
python3 - <<'PY'
import json
x=json.load(open('/tmp/sot-v8-https.json'))
