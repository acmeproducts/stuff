...
function mnxEnsureHealthTabs(){
  ...
  if(!bar){
    ...
    bar.innerHTML=`<button class="btn" type="button" role="tab" data-mnx-health="sources">Sources</button><button class="btn" type="button" role="tab" data-mnx-health="models">Derived Models</button>`;
...
function mnxModelCardHtml(m){
  ...
  <div class="mnxGrid">
   ...
   <div class="mnxMetric">Components available<b>${esc(cov)} (${esc(m.coverageStatus||'—')})</b></div>
...
function mnxRenderHealth(){
  ...
  if(mnxHealthTab!=='models'){renderHealth();return}
