...
if len(sys.argv) != 3:
    raise SystemExit('usage: generate-SOT-turn01-base14.py <clean-base3-api.js> <output-api.js>')
...
windows_drives = r'''function windowsDriveLetters() {
  try {
...
src = replace_function(src, 'windowsDriveLetters', windows_drives)
...
src = src.replace("const BUILD = '2026.08.28.sot-turn01-base-3';", "const BUILD = '2026.08.29.sot-turn01-base-14';", 1)
for marker in [
    "const BUILD = '2026.08.29.sot-turn01-base-14';",
    'function windowsListDirectories(value)', 'function windowsDirectoryExists(value)',
    'target_browse_root:', 'backup_browse_root:', 'windowsListDirectories(requested)',
    '/mnt/c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe'
]:
    if marker not in src:
        raise SystemExit(f'Base-14 contract missing: {marker}')
...
print('Base-14 generated from clean Base-3 with balanced function parsing')
