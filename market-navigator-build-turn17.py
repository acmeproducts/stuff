...
# Presentation-only Data bindings. Existing AI/Print/download behavior is left intact.
end = s.rfind('</script>')
if end < 0:
...
required = [
    ...
    'Correlation', 'Native', 'Index 100', 'data-emphasis',
]
